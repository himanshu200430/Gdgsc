...
const Footer = () => {
        ...
        <div className="footer-center">
          <div className="court-section">
            <h3 className="section-title">
              <span className="title-decoration">⚔️</span> Follow Us <span className="title-decoration">⚔️</span>
            </h3>
  ...
  <a href="mailto:developersgdgsc@gmail.com" className="social-link email">
   <IoIosMail size={30} />
          ...
          <div className="messenger-section">
            ...
            <a className="messenger-link" style={{fontSize:"1.2em"}} href="mailto:developersgdgsc@gmail.com" >
        ...
        <div className="footer-right">
          <h3 className="contact-title">
            <span className="title-ornament">✦</span> Get In Touch <span className="title-ornament">✦</span>
          </h3>
